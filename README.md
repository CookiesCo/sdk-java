...
```groovy
dependencies {
    implementation 'co.cookies.sdk:sdk-java:v1.2021r1'
}
...
maven_jar(
  name = "co_cookies_sdk",
  artifact = "co.cookies.sdk.sdk-java:v1.2021r1",
  sha256 = "75ba08cae08903528149d8c4c96204416e8d87d74af6a8f470e5c28de401cabc",
)
```
